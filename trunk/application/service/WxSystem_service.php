...
class WxSystem_service extends MY_Service {
	...
	public function WxConfig($token){
        $res_array = array(
            "appId"=>"",
            "timestamp"=>"",
            "nonceStr"=>"",
        ...
        if(!empty($token)){
            ...
            if(!empty($wxSystem)){
                $res_array['appId'] = $wxSystem['wxs_app_id'];
                $res_array['timestamp'] = time();
                $res_array['nonceStr'] = $wxSystem['wxs_app_id'];
                $res_array['signature'] = $wxSystem['wxs_app_id'];
                $res_array['jsApiList'] = $wxSystem['wxs_app_id'];
