<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-06-07 17:45:27
         compiled from "/Library/WebServer/Documents/weixin/trunk/application/views/admin/myblogchannel/index.html" */ ?>
<?php /*%%SmartyHeaderCode:8081621225937cb37bb2875-32943728%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '159f57767290fa53d28c6e0ea0eacf077814847b' => 
    array (
      0 => '/Library/WebServer/Documents/weixin/trunk/application/views/admin/myblogchannel/index.html',
      1 => 1482308602,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8081621225937cb37bb2875-32943728',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5937cb37c33e43_64588142',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5937cb37c33e43_64588142')) {function content_5937cb37c33e43_64588142($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-list"></i>博客分类列表</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">
										<button onclick="location='/Admin_MyBlogChannel/add'" class="btn green" >
											新建分类 <i class="icon-plus"></i>
										</button>
									</div>
...
?>
									<tr class="">
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['channel_id'];?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['channel_name'];?>
</td>
										<td><?php echo menu_hide($_smarty_tpl->tpl_vars['v']->value['channel_hide']);?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['channel_note'];?>
</td>
										<td><?php echo status($_smarty_tpl->tpl_vars['v']->value['status']);?>
</td>
										<td>
										<a class="btn_g icn-only <?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>yellow<?php } else { ?>blue<?php }?>" href="/Admin_MyBlogChannel/<?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>disable<?php } else { ?>enable<?php }?>?channel_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['channel_id'];?>
">
											<?php echo status_btn($_smarty_tpl->tpl_vars['v']->value['status']);?>

										</a>&nbsp;&nbsp;
										<a class="btn_g purple icn-only" href="/Admin_MyBlogChannel/edit?channel_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['channel_id'];?>
">
											修改
										</a>&nbsp;&nbsp;
										<a class="btn_g red icn-only" href="/Admin_MyBlogChannel/del?channel_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['channel_id'];?>
">
											删除
										</a>
										</td>
