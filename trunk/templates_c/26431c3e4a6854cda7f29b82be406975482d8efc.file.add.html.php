<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-06-08 15:55:06
         compiled from "/Library/WebServer/Documents/weixin/trunk/application/views/admin/myblogchannel/add.html" */ ?>
<?php /*%%SmartyHeaderCode:757055588593902da20dbb6-38900842%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '26431c3e4a6854cda7f29b82be406975482d8efc' => 
    array (
      0 => '/Library/WebServer/Documents/weixin/trunk/application/views/admin/myblogchannel/add.html',
      1 => 1488080339,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '757055588593902da20dbb6-38900842',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_593902da2590e2_57616482',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_593902da2590e2_57616482')) {function content_593902da2590e2_57616482($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="/Admin_MyBlogChannel/index">博客分类管理</a>
							</li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>博客分类添加</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="/Admin_MyBlogChannel/add" method="post" class="form-horizontal">
									<div class="control-group">
										<label class="control-label">分类名称：</label>
										<div class="controls">
											<input type="text" name="channel_name" placeholder="请输入分类名称，最少2位字符" minlength="2" maxlength="28" class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="channel_note" placeholder="请输入备注" />
										</div>
									</div>
