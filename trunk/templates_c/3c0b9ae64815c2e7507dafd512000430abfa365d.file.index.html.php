<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-24 10:14:37
         compiled from "/Library/WebServer/Documents/weixin/trunk/application/views/admin/myusergroup/index.html" */ ?>
<?php /*%%SmartyHeaderCode:86629309758fd5f8db06c46-52586733%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3c0b9ae64815c2e7507dafd512000430abfa365d' => 
    array (
      0 => '/Library/WebServer/Documents/weixin/trunk/application/views/admin/myusergroup/index.html',
      1 => 1491383338,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '86629309758fd5f8db06c46-52586733',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58fd5f8db9add2_48580283',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58fd5f8db9add2_48580283')) {function content_58fd5f8db9add2_48580283($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-list"></i>账户组列表</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">
										<button onclick="location='/Admin_MyUserGroup/add'" class="btn green" >
											新建账户组 <i class="icon-plus"></i>
										</button>
									</div>
...
?>
									<tr class="">
										...
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['group_desc'];?>
</td>
										<td><?php echo status($_smarty_tpl->tpl_vars['v']->value['status']);?>
</td>
										<td>
										<a class="btn_g icn-only <?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>yellow<?php } else { ?>blue<?php }?>" href="/Admin_MyUserGroup/<?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>disable<?php } else { ?>enable<?php }?>?group_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['group_id'];?>
">
											<?php echo status_btn($_smarty_tpl->tpl_vars['v']->value['status']);?>

										</a>&nbsp;&nbsp;
										<a class="btn_g purple icn-only" href="/Admin_MyUserGroup/edit?group_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['group_id'];?>
">
											修改
										</a>&nbsp;&nbsp;
										<a class="btn_g red icn-only" href="/Admin_MyUserGroup/del?group_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['group_id'];?>
">
											删除
										</a>
										</td>
