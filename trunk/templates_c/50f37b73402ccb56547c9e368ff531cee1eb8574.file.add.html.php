<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-10 23:02:29
         compiled from "/Library/WebServer/Documents/weixin/trunk/application/views/admin/wxvoterecord/add.html" */ ?>
<?php /*%%SmartyHeaderCode:20619518258eb9c44bf5d25-79437938%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '50f37b73402ccb56547c9e368ff531cee1eb8574' => 
    array (
      0 => '/Library/WebServer/Documents/weixin/trunk/application/views/admin/wxvoterecord/add.html',
      1 => 1491836540,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20619518258eb9c44bf5d25-79437938',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_58eb9c44c343e7_90161482',
  'variables' => 
  array (
    'web_name' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_58eb9c44c343e7_90161482')) {function content_58eb9c44c343e7_90161482($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="/Admin_WxVoteRecord/add" method="post" class="form-horizontal" enctype="multipart/form-data" >
									<div class="control-group">
										<label class="control-label">选手ID：</label>
										<div class="controls">
											<input type="text" name="item_id" placeholder="请输入活动关键字，最少2位字符" class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="vid" placeholder="请输入活动标题，最少2位字符"  class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="wecha_id" placeholder="请输入微信ID" class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="token" placeholder="请输入引导关注提示，最少2位字符" class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="touched" placeholder="请输入微信投票数" class="span6 m-wrap" />
