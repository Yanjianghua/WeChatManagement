<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-12 17:11:54
         compiled from "/Library/WebServer/Documents/weixin/trunk/application/views/admin/wxvotefile/add.html" */ ?>
<?php /*%%SmartyHeaderCode:191801444058ed8b94e5a405-16096504%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '51df77d6a89d6152106dfde84fe541716c71fd90' => 
    array (
      0 => '/Library/WebServer/Documents/weixin/trunk/application/views/admin/wxvotefile/add.html',
      1 => 1491988304,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '191801444058ed8b94e5a405-16096504',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_58ed8b94e9ad03_56501325',
  'variables' => 
  array (
    'web_name' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_58ed8b94e9ad03_56501325')) {function content_58ed8b94e9ad03_56501325($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="/Admin_WxVoteFile/index">微信上传文件管理</a>
							</li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>微信上传文件添加</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="/Admin_WxVoteFile/add" method="post" class="form-horizontal" enctype="multipart/form-data" >
									<div class="control-group">
										...
										<div class="controls">
											...
											<span class="help-inline">请选择素材类型</span>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">名称：</label>
										<div class="controls">
											<input type="text" name="name" placeholder="请输入名称" class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="file" name="url" placeholder="请输入上传文件"  class="span6 m-wrap" />
											<span class="help-inline">请选择上传文件</span>
										</div>
									</div>
