<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-05-23 11:06:22
         compiled from "/Library/WebServer/Documents/weixin/trunk/application/views/admin/wxmenu/index.html" */ ?>
<?php /*%%SmartyHeaderCode:104118472058f47cc514c4f2-73364180%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6696f2bc1dfa23500cf85af6d59f5f5a3100597d' => 
    array (
      0 => '/Library/WebServer/Documents/weixin/trunk/application/views/admin/wxmenu/index.html',
      1 => 1492658615,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '104118472058f47cc514c4f2-73364180',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_58f47cc5203518_81487814',
  'variables' => 
  array (
    'web_name' => 0,
    'WxMenu' => 0,
...
<?php if ($_valid && !is_callable('content_58f47cc5203518_81487814')) {function content_58f47cc5203518_81487814($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-list"></i>微信自定义菜单列表</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">
										<button onclick="location='/Admin_WxMenu/add'" class="btn green" >
											新建微信自定义菜单 <i class="icon-plus"></i>
										</button>
									</div>
									<div class="btn-group pull-right">
										<button onclick="location='/Admin_WxMenu/make'" class="btn green" >
											生成微信菜单 <i class="icon-plus"></i>
										</button>
									</div>
								</div>
								<table class="table table-striped table-hover table-bordered" id="">
									...
									<tbody>
									<?php if (!empty($_smarty_tpl->tpl_vars['WxMenu']->value)) {?>
									<?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['v']->_loop = false;
 $_smarty_tpl->tpl_vars['k'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['WxMenu']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
									<tr class="">
										...
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['keyword'];?>
</td>
										...
										<td><?php echo menu_hide($_smarty_tpl->tpl_vars['v']->value['is_show']);?>
</td>
										<td>
										<a class="btn_g purple icn-only" href="/Admin_WxMenu/edit?id=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
">
											修改
										</a>&nbsp;&nbsp;
										<a class="btn_g red icn-only" href="/Admin_WxMenu/del?id=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
">
											删除
										</a>
										</td>
...
?>
										<tr class="">
											...
											<td><?php echo $_smarty_tpl->tpl_vars['v1']->value['keyword'];?>
</td>
											<td><?php echo $_smarty_tpl->tpl_vars['v1']->value['sort'];?>
</td>
											<td><?php echo $_smarty_tpl->tpl_vars['v1']->value['token'];?>
</td>
											<td><?php echo $_smarty_tpl->tpl_vars['v1']->value['pid'];?>
</td>
											<td><?php echo $_smarty_tpl->tpl_vars['v1']->value['url'];?>
</td>
											<td><?php echo menu_hide($_smarty_tpl->tpl_vars['v1']->value['is_show']);?>
</td>
											<td>
												<a class="btn_g purple icn-only" href="/Admin_WxMenu/edit?id=<?php echo $_smarty_tpl->tpl_vars['v1']->value['id'];?>
">
													修改
												</a>&nbsp;&nbsp;
												<a class="btn_g red icn-only" href="/Admin_WxMenu/del?id=<?php echo $_smarty_tpl->tpl_vars['v1']->value['id'];?>
">
													删除
												</a>
											</td>
