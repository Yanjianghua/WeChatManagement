<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-05 17:31:06
         compiled from "/Library/WebServer/Documents/weixin/trunk/application/views/admin/mysystem/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:151002879558e4b95ae2baf2-39657046%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '78037febb87c8967a0e58231acc058d53d57f7b6' => 
    array (
      0 => '/Library/WebServer/Documents/weixin/trunk/application/views/admin/mysystem/edit.html',
      1 => 1488080508,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '151002879558e4b95ae2baf2-39657046',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58e4b95ae6ff21_08919076',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58e4b95ae6ff21_08919076')) {function content_58e4b95ae6ff21_08919076($_smarty_tpl) {?><!DOCTYPE html>
				...
				<div class="span12">
					...
					<ul class="breadcrumb">
						<li>
							...
							<a href="/Admin_MyMenu/index">网站配置修改</a>
						</li>
					</ul>
				</div>
			</div>
				...
				<div class="span12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="icon-reorder"></i>网站配置修改</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="/Admin_MySystem/edit" method="post" class="form-horizontal">
								<div class="control-group">
									<label class="control-label">网站名称：</label>
									<div class="controls">
										<input type="text" name="web_name" placeholder="请输入网站名称，最少1位字符" minlength="1" maxlength="18" class="span6 m-wrap" value="<?php echo $_smarty_tpl->tpl_vars['sys_info']->value['web_name'];?>
"/>
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="server_url" placeholder="请输入网站地址" minlength="6" maxlength="128" class="span6 m-wrap" value="<?php echo $_smarty_tpl->tpl_vars['sys_info']->value['server_url'];?>
" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">验证码地址：</label>
									<div class="controls">
										<input type="text" name="code" placeholder="请输入网站地址" minlength="6" maxlength="128" class="span6 m-wrap" value="<?php echo $_smarty_tpl->tpl_vars['sys_info']->value['code'];?>
" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">底部导航栏：</label>
									<div class="controls">

										<textarea class="span6 m-wrap" name="footer"  rows="8"><?php echo $_smarty_tpl->tpl_vars['sys_info']->value['footer'];?>
</textarea>
									</div>
								</div>
