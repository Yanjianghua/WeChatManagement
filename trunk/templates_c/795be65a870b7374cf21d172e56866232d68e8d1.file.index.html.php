<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-06 23:52:34
         compiled from "/Library/WebServer/Documents/weixin/trunk/application/views/admin/wxsystem/index.html" */ ?>
<?php /*%%SmartyHeaderCode:132849943458e60be9890fe2-74200999%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '795be65a870b7374cf21d172e56866232d68e8d1' => 
    array (
      0 => '/Library/WebServer/Documents/weixin/trunk/application/views/admin/wxsystem/index.html',
      1 => 1491493951,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '132849943458e60be9890fe2-74200999',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_58e60be991f5e9_68983556',
  'variables' => 
  array (
    'web_name' => 0,
    'WxSystem' => 0,
...
<?php if ($_valid && !is_callable('content_58e60be991f5e9_68983556')) {function content_58e60be991f5e9_68983556($_smarty_tpl) {?><!DOCTYPE html>
...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-list"></i>微信配置列表</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">
										<button onclick="location='/Admin_WxSystem/add'" class="btn green" >
											新建微信配置 <i class="icon-plus"></i>
										</button>
									</div>
 ...
 $_from = $_smarty_tpl->tpl_vars['WxSystem']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['v']->key => $_smarty_tpl->tpl_vars['v']->value) {
$_smarty_tpl->tpl_vars['v']->_loop = true;
 $_smarty_tpl->tpl_vars['k']->value = $_smarty_tpl->tpl_vars['v']->key;
?>
									<tr class="">
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['wxs_id'];?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['user_id'];?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['rolename'];?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['wxs_name'];?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['wxs_token'];?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['wxs_app_id'];?>
</td>
										<td><?php echo status($_smarty_tpl->tpl_vars['v']->value['status']);?>
</td>
										<td>
										<a class="btn_g icn-only <?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>yellow<?php } else { ?>blue<?php }?>" href="/Admin_WxSystem/<?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>disable<?php } else { ?>enable<?php }?>?wxs_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['wxs_id'];?>
">
											<?php echo status_btn($_smarty_tpl->tpl_vars['v']->value['status']);?>

										</a>&nbsp;&nbsp;
										<a class="btn_g purple icn-only" href="/Admin_WxSystem/edit?wxs_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['wxs_id'];?>
">
											修改
										</a>&nbsp;&nbsp;
										<a class="btn_g red icn-only" href="/Admin_WxSystem/del?wxs_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['wxs_id'];?>
">
											删除
										</a>
										</td>
