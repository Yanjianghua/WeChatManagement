<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-12 19:39:11
         compiled from "/Library/WebServer/Documents/weixin/trunk/application/views/admin/wxvotefile/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:9621926158ee0e155033c8-89731737%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '79d4ec04d6e457f6011c49a157420a340a10d0a7' => 
    array (
      0 => '/Library/WebServer/Documents/weixin/trunk/application/views/admin/wxvotefile/edit.html',
      1 => 1491997148,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9621926158ee0e155033c8-89731737',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_58ee0e1553d1e8_11458838',
  'variables' => 
  array (
    'web_name' => 0,
    'WxVoteFile' => 0,
...
<?php if ($_valid && !is_callable('content_58ee0e1553d1e8_11458838')) {function content_58ee0e1553d1e8_11458838($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="/Admin_WxVoteFile/index">微信上传管理</a>
							</li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>微信上传修改</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="/Admin_WxVoteFile/edit" method="post" class="form-horizontal" enctype="multipart/form-data" >
									<div class="control-group">
										<label class="control-label">选择类型：</label>
										<div class="controls">
											<select class="span6 m-wrap" name="type" data-placeholder="Choose a Category" >
												<option value="">选择账户组……</option>
												<?php if (!empty($_smarty_tpl->tpl_vars['WxVoteFile']->value['type'])) {?>
												<option value="img" <?php if ($_smarty_tpl->tpl_vars['WxVoteFile']->value['type']=='img') {?>selected <?php }?>>图片</option>
												<option value="mp3" <?php if ($_smarty_tpl->tpl_vars['WxVoteFile']->value['type']=='mp3') {?>selected <?php }?>>音乐</option>
												<?php }?>
											</select>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="hidden" name="id" value="<?php echo $_smarty_tpl->tpl_vars['WxVoteFile']->value['id'];?>
" >
											<input type="text" name="name" value="<?php echo $_smarty_tpl->tpl_vars['WxVoteFile']->value['name'];?>
" placeholder="请输入名称" class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="file" name="url" placeholder="请输入投票ID"  class="span6 m-wrap" />
											<?php if (!empty($_smarty_tpl->tpl_vars['WxVoteFile']->value['url'])) {?>
											<?php if ($_smarty_tpl->tpl_vars['WxVoteFile']->value['type']=='img') {?>
											<span class="help-inline">已上传图片：</span><img src="<?php echo $_smarty_tpl->tpl_vars['WxVoteFile']->value['url'];?>
" height="100px" width="100px">
											<?php } elseif ($_smarty_tpl->tpl_vars['WxVoteFile']->value['type']=='mp3') {?>
											<span class="help-inline">已上传音乐：</span><audio controls="controls"><source src="<?php echo $_smarty_tpl->tpl_vars['WxVoteFile']->value['url'];?>
" /></audio>
											<?php }?>
											<?php }?>
										</div>
