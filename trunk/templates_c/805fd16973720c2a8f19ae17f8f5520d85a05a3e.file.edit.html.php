<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-06 23:53:31
         compiled from "/Library/WebServer/Documents/weixin/trunk/application/views/admin/wxsystem/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:166049439158e62346348ae8-46234068%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '805fd16973720c2a8f19ae17f8f5520d85a05a3e' => 
    array (
      0 => '/Library/WebServer/Documents/weixin/trunk/application/views/admin/wxsystem/edit.html',
      1 => 1491493993,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '166049439158e62346348ae8-46234068',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_58e623463947e2_70169020',
  'variables' => 
  array (
    'web_name' => 0,
    'wxs' => 0,
...
<?php if ($_valid && !is_callable('content_58e623463947e2_70169020')) {function content_58e623463947e2_70169020($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="/Admin_WxSystem/index">微信配置管理</a>
							</li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>微信配置修改</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="/Admin_WxSystem/edit" method="post" class="form-horizontal">
									<div class="control-group">
										<label class="control-label">公众号名称：</label>
										<div class="controls">
											<input type="hidden" name="wxs_id" value="<?php echo $_smarty_tpl->tpl_vars['wxs']->value['wxs_id'];?>
">
											<input type="hidden" name="wxs_token" value="<?php echo $_smarty_tpl->tpl_vars['wxs']->value['wxs_token'];?>
">
											<input type="text" name="wxs_name" placeholder="请输入公众号名称，最少2位字符" value="<?php echo $_smarty_tpl->tpl_vars['wxs']->value['wxs_name'];?>
" minlength="2" maxlength="18" class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="wxs_app_id" placeholder="请输入AppID，最少2位字符" value="<?php echo $_smarty_tpl->tpl_vars['wxs']->value['wxs_app_id'];?>
" minlength="2" maxlength="180" class="span6 m-wrap" />
											<span class="help-inline">请输入AppID</span>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">AppSecret：</label>
										<div class="controls">
											<input type="text" name="wxs_app_secret" placeholder="请输入AppSecret，最少2位字符" value="<?php echo $_smarty_tpl->tpl_vars['wxs']->value['wxs_app_secret'];?>
" minlength="2" maxlength="180" class="span6 m-wrap" />
											<span class="help-inline">请输入AppSecret</span>
										</div>
									</div>
