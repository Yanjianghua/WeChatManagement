<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-06-08 16:03:02
         compiled from "/Library/WebServer/Documents/weixin/trunk/application/views/admin/myblogmessage/index.html" */ ?>
<?php /*%%SmartyHeaderCode:2124039179593904b61f4e72-10294857%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9ab7519a0df1e3322fe16a0cdeafa9c524767cd5' => 
    array (
      0 => '/Library/WebServer/Documents/weixin/trunk/application/views/admin/myblogmessage/index.html',
      1 => 1482335302,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2124039179593904b61f4e72-10294857',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_593904b628cb72_98934869',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_593904b628cb72_98934869')) {function content_593904b628cb72_98934869($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-list"></i>博客留言板列表</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">
										<button onclick="location='/Admin_MyBlogMessage/add'" class="btn green" >
											新建留言版 <i class="icon-plus"></i>
										</button>
									</div>
...
?>
									<tr class="">
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['message_id'];?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['message_title'];?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['message_telephone'];?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['message_email'];?>
</td>
										<td><?php echo cut_str($_smarty_tpl->tpl_vars['v']->value['message_note'],20);?>
</td>
										<td><?php echo status($_smarty_tpl->tpl_vars['v']->value['status']);?>
</td>
										<td>
										<a class="btn_g icn-only <?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>yellow<?php } else { ?>blue<?php }?>" href="/Admin_MyBlogMessage/<?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>disable<?php } else { ?>enable<?php }?>?message_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['message_id'];?>
">
											<?php echo status_btn($_smarty_tpl->tpl_vars['v']->value['status']);?>

										</a>&nbsp;&nbsp;
										<a class="btn_g purple icn-only" href="/Admin_MyBlogMessage/edit?message_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['message_id'];?>
">
											修改
										</a>&nbsp;&nbsp;
										<a class="btn_g red icn-only" href="/Admin_MyBlogMessage/del?message_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['message_id'];?>
">
											删除
										</a>
										</td>
