<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-05-31 23:33:45
         compiled from "/Library/WebServer/Documents/weixin/trunk/application/views/admin/wxvote/index.html" */ ?>
<?php /*%%SmartyHeaderCode:200975562458e75d10bbaef9-18311430%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ab109f44038b298bfe79446c0ef63df7d793b37c' => 
    array (
      0 => '/Library/WebServer/Documents/weixin/trunk/application/views/admin/wxvote/index.html',
      1 => 1496244824,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '200975562458e75d10bbaef9-18311430',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_58e75d10c97fb3_13349706',
  'variables' => 
  array (
    'web_name' => 0,
    'WxVote' => 0,
...
<?php if ($_valid && !is_callable('content_58e75d10c97fb3_13349706')) {function content_58e75d10c97fb3_13349706($_smarty_tpl) {?><!DOCTYPE html>
...
?>
									<tr class="">
										...
										<td><?php echo cut_str($_smarty_tpl->tpl_vars['v']->value['title'],15);?>
</td>
										...
										<td><?php echo date("Y-m-d H:i:s",$_smarty_tpl->tpl_vars['v']->value['statdate']);?>
&nbsp;到<br/><?php echo date("Y-m-d H:i:s",$_smarty_tpl->tpl_vars['v']->value['enddate']);?>
</td>
										<td><?php echo date("Y-m-d H:i:s",$_smarty_tpl->tpl_vars['v']->value['start_time']);?>
&nbsp;到<br/><?php echo date("Y-m-d H:i:s",$_smarty_tpl->tpl_vars['v']->value['over_time']);?>
</td>
										<td><?php echo status($_smarty_tpl->tpl_vars['v']->value['status']);?>
</td>
										<td>
										<a class="btn_g icn-only <?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>yellow<?php } else { ?>blue<?php }?>" href="/Admin_WxVote/<?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>disable<?php } else { ?>enable<?php }?>?id=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
">
											<?php echo status_btn($_smarty_tpl->tpl_vars['v']->value['status']);?>

										</a>&nbsp;&nbsp;
										<a class="btn_g purple icn-only" href="/Admin_WxVote/edit?id=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
">
											修改
										</a>&nbsp;&nbsp;
										<a class="btn_g red icn-only" href="/Admin_WxVote/del?id=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
">
											删除
										</a>
										</td>
