<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-06-08 15:59:47
         compiled from "/Library/WebServer/Documents/weixin/trunk/application/views/admin/mybloglabel/index.html" */ ?>
<?php /*%%SmartyHeaderCode:982359237593903f3e5a204-70863808%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b3da64c1ef71129564592273864aefc0a8f3cccb' => 
    array (
      0 => '/Library/WebServer/Documents/weixin/trunk/application/views/admin/mybloglabel/index.html',
      1 => 1482332021,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '982359237593903f3e5a204-70863808',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_593903f3edbf57_63724828',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_593903f3edbf57_63724828')) {function content_593903f3edbf57_63724828($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-list"></i>博客标签列表</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">
										<button onclick="location='/Admin_MyBlogLabel/add'" class="btn green" >
											新建标签 <i class="icon-plus"></i>
										</button>
									</div>
...
?>
									<tr class="">
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['label_id'];?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['label_name'];?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['label_note'];?>
</td>
										<td><?php echo status($_smarty_tpl->tpl_vars['v']->value['status']);?>
</td>
										<td>
										<a class="btn_g icn-only <?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>yellow<?php } else { ?>blue<?php }?>" href="/Admin_MyBlogLabel/<?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>disable<?php } else { ?>enable<?php }?>?label_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['label_id'];?>
">
											<?php echo status_btn($_smarty_tpl->tpl_vars['v']->value['status']);?>

										</a>&nbsp;&nbsp;
										<a class="btn_g purple icn-only" href="/Admin_MyBlogLabel/edit?label_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['label_id'];?>
">
											修改
										</a>&nbsp;&nbsp;
										<a class="btn_g red icn-only" href="/Admin_MyBlogLabel/del?label_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['label_id'];?>
">
											删除
										</a>
										</td>
