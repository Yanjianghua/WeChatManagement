<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-06-11 10:57:31
         compiled from "/Library/WebServer/Documents/weixin/trunk/application/views/default/layout/index.html" */ ?>
<?php /*%%SmartyHeaderCode:105620129358e4b7261c56d3-19270189%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c32f7b95cf613e063f3cc12baf83a868ecedba2f' => 
    array (
      0 => '/Library/WebServer/Documents/weixin/trunk/application/views/default/layout/index.html',
      1 => 1496920884,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '105620129358e4b7261c56d3-19270189',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_58e4b726203320_58172454',
  'variables' => 
  array (
    'web_name' => 0,
    'article_recommend' => 0,
...
<?php if ($_valid && !is_callable('content_58e4b726203320_58172454')) {function content_58e4b726203320_58172454($_smarty_tpl) {?><!DOCTYPE html>
...
<head>
    ...
    <meta content="智涵网络,智涵网络科技公司,智涵" name="keywords" />
    <meta content="智涵网络,智涵网络科技公司,智涵" name="description" />
...
<div class="row-fluid">
    <div class="news-Navigation">
        <div class="new-boke"><h3><a href="/" target="_blank"><?php echo $_smarty_tpl->tpl_vars['web_name']->value;?>
-文章搜索</a></h3></div>
...
.html" target="_blank"><?php echo $_smarty_tpl->tpl_vars['value']->value['article_title'];?>
                    ...
                    <div class="news-block-tags">
                        ...
                        <em><?php echo date("Y-m-d",$_smarty_tpl->tpl_vars['value']->value['addtime']);?>
</em>
                    </div>
                    <p><img class="news-block-img pull-right" src="<?php if ($_smarty_tpl->tpl_vars['value']->value['pic_url']!=$_smarty_tpl->tpl_vars['server_url']->value&&!empty($_smarty_tpl->tpl_vars['value']->value['pic_url'])) {
echo $_smarty_tpl->tpl_vars['value']->value['pic_url'];
} else { ?>/statics/media/image/php-layout.jpg<?php }?>" alt=""><?php echo $_smarty_tpl->tpl_vars['value']->value['article_description'];?>
</p>
                    <a href="/article/<?php echo $_smarty_tpl->tpl_vars['value']->value['article_id'];?>
...
.html" target="_blank"><?php echo $_smarty_tpl->tpl_vars['value']->value['article_title'];?>
                    ...
                    <p><img class="news-block-img pull-right" src="<?php if ($_smarty_tpl->tpl_vars['value']->value['pic_url']!=$_smarty_tpl->tpl_vars['server_url']->value&&!empty($_smarty_tpl->tpl_vars['value']->value['pic_url'])) {
echo $_smarty_tpl->tpl_vars['value']->value['pic_url'];
} else { ?>/statics/media/image/linux-layout.jpeg<?php }?>" alt=""><?php echo $_smarty_tpl->tpl_vars['value']->value['article_description'];?>
</p>
                    <a href="/article/<?php echo $_smarty_tpl->tpl_vars['value']->value['article_id'];?>
...
.html" target="_blank"><?php echo $_smarty_tpl->tpl_vars['value']->value['article_title'];?>
                    ...
                    <p><img class="news-block-img pull-right" src="<?php if ($_smarty_tpl->tpl_vars['value']->value['pic_url']!=$_smarty_tpl->tpl_vars['server_url']->value&&!empty($_smarty_tpl->tpl_vars['value']->value['pic_url'])) {
echo $_smarty_tpl->tpl_vars['value']->value['pic_url'];
} else { ?>/statics/media/image/mysql-layout.jpg<?php }?>" alt=""><?php echo $_smarty_tpl->tpl_vars['value']->value['article_description'];?>
</p>
                    <a href="/article/<?php echo $_smarty_tpl->tpl_vars['value']->value['article_id'];?>
.html" class="news-block-btn" target="_blank">
                        阅读原文
...
.html" target="_blank"><?php echo $_smarty_tpl->tpl_vars['value']->value['article_title'];?>
                    ...
                    <p><img class="news-block-img pull-right" src="<?php if ($_smarty_tpl->tpl_vars['value']->value['pic_url']!=$_smarty_tpl->tpl_vars['server_url']->value&&!empty($_smarty_tpl->tpl_vars['value']->value['pic_url'])) {
echo $_smarty_tpl->tpl_vars['value']->value['pic_url'];
} else { ?>/statics/media/image/js-layout.jpg<?php }?>" alt=""><?php echo $_smarty_tpl->tpl_vars['value']->value['article_description'];?>
</p>
                    <a href="/article/<?php echo $_smarty_tpl->tpl_vars['value']->value['article_id'];?>
.html" class="news-block-btn" target="_blank">
                        阅读原文
...
.html" target="_blank"><?php echo $_smarty_tpl->tpl_vars['value']->value['article_title'];?>
                    ...
                    <p><img class="news-block-img pull-right" src="<?php if ($_smarty_tpl->tpl_vars['value']->value['pic_url']!=$_smarty_tpl->tpl_vars['server_url']->value&&!empty($_smarty_tpl->tpl_vars['value']->value['pic_url'])) {
echo $_smarty_tpl->tpl_vars['value']->value['pic_url'];
} else { ?>/statics/media/image/http-layout.png<?php }?>" alt=""><?php echo $_smarty_tpl->tpl_vars['value']->value['article_description'];?>
</p>
                    <a href="/article/<?php echo $_smarty_tpl->tpl_vars['value']->value['article_id'];?>
.html" target="_blank" class="news-block-btn">
                        阅读原文
...
.html" target="_blank"><?php echo $_smarty_tpl->tpl_vars['value']->value['article_title'];?>
                    ...
                    <p><img class="news-block-img pull-right" src="<?php if ($_smarty_tpl->tpl_vars['value']->value['pic_url']!=$_smarty_tpl->tpl_vars['server_url']->value&&!empty($_smarty_tpl->tpl_vars['value']->value['pic_url'])) {
echo $_smarty_tpl->tpl_vars['value']->value['pic_url'];
} else { ?>/statics/media/image/new-layout.jpg<?php }?>" alt=""><?php echo cut_str($_smarty_tpl->tpl_vars['value']->value['article_description'],50);?>
...</p>
                    <a href="/article/<?php echo $_smarty_tpl->tpl_vars['value']->value['article_id'];?>
.html" target="_blank" class="news-block-btn">
                        阅读原文
