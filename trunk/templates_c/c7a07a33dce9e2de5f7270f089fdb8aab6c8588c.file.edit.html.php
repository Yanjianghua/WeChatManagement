<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-06-08 17:01:15
         compiled from "/Library/WebServer/Documents/weixin/trunk/application/views/admin/myblogchannel/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:6482749175939125b339504-37026706%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c7a07a33dce9e2de5f7270f089fdb8aab6c8588c' => 
    array (
      0 => '/Library/WebServer/Documents/weixin/trunk/application/views/admin/myblogchannel/edit.html',
      1 => 1488080346,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6482749175939125b339504-37026706',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5939125b39cd35_97489967',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5939125b39cd35_97489967')) {function content_5939125b39cd35_97489967($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="/Admin_MyUser/index">博客分类管理</a>
							</li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>博客分类修改</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="/Admin_MyBlogChannel/edit" method="post" class="form-horizontal">
									<div class="control-group">
										<label class="control-label">分类名称：</label>
										<div class="controls">
										    <input type="hidden" name="channel_id" value="<?php echo $_smarty_tpl->tpl_vars['channel']->value['channel_id'];?>
" />
											<input type="text" name="channel_name" placeholder="请输入分类名称，最少2位字符" minlength="2" maxlength="28" class="span6 m-wrap" value="<?php echo $_smarty_tpl->tpl_vars['channel']->value['channel_name'];?>
" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<select class="span6 m-wrap" name="channel_hide" data-placeholder="Choose a Category" >
												<option value="">选择是否显示……</option>
												<option value="1" <?php if ($_smarty_tpl->tpl_vars['channel']->value['channel_hide']) {?>selected<?php }?>>是</option>
												<option value="0" <?php if (!$_smarty_tpl->tpl_vars['channel']->value['channel_hide']) {?>selected<?php }?>>否</option>
											</select>
											<span class="help-inline">请选择是否显示</span>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">分类备注：</label>
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="channel_note" placeholder="请输入备注" value="<?php echo $_smarty_tpl->tpl_vars['channel']->value['channel_note'];?>
" />
										</div>
									</div>
