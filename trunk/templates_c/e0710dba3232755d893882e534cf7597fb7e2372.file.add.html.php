<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-06-02 16:44:13
         compiled from "/Library/WebServer/Documents/weixin/trunk/application/views/admin/wxvoteitem/add.html" */ ?>
<?php /*%%SmartyHeaderCode:107085205958eafc0f0cd082-24250237%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e0710dba3232755d893882e534cf7597fb7e2372' => 
    array (
      0 => '/Library/WebServer/Documents/weixin/trunk/application/views/admin/wxvoteitem/add.html',
      1 => 1496244930,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '107085205958eafc0f0cd082-24250237',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_58eafc0f123922_72523540',
  'variables' => 
  array (
    'web_name' => 0,
    'WxVote' => 0,
...
<?php if ($_valid && !is_callable('content_58eafc0f123922_72523540')) {function content_58eafc0f123922_72523540($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>微信投票选手添加</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="/Admin_WxVoteItem/add" method="post" class="form-horizontal" enctype="multipart/form-data">
...
"><?php echo $_smarty_tpl->tpl_vars['v']->value['title'];?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="name" placeholder="请输入姓名，最少2位字符" minlength="2" maxlength="180" class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="number" name="vcount" placeholder="请输入虚拟投票数，最少2位字符" minlength="2" maxlength="180" class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="file" name="startpicurl" style="border:1px solid red;" class="span6"/>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label"> 图片上传2：</label>
										<div class="controls">
											<input type="file" name="startpicurl2" style="border:1px solid red;" class="span6"/>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label"> 图片上传3：</label>
										<div class="controls">
											<input type="file" name="startpicurl3" style="border:1px solid red;" class="span6"/>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label"> 图片上传4：</label>
										<div class="controls">
											<input type="file" name="startpicurl4" style="border:1px solid red;" class="span6"/>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label"> 图片上传5：</label>
										<div class="controls">
											<input type="file" name="startpicurl5" style="border:1px solid red;" class="span6"/>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">手机号：</label>
										<div class="controls">
											<input type="number" name="tourl" placeholder="请输入手机号" min="10000000000" max="99999999999" class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="number" name="tourl" placeholder="请输入排序号" min="1" max="100" class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="intro" placeholder="请输入简介"  class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="wechat" placeholder="请输入微信号"  class="span6 m-wrap" />
											<span class="help-inline">请输入简介</span>
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="lockinfo" placeholder="请输入消息" class="span6 m-wrap" />
