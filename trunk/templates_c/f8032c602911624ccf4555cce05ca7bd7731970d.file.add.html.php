<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-06 19:10:23
         compiled from "/Library/WebServer/Documents/weixin/trunk/application/views/admin/wxsystem/add.html" */ ?>
<?php /*%%SmartyHeaderCode:168567032758e6221fee21a6-90293659%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f8032c602911624ccf4555cce05ca7bd7731970d' => 
    array (
      0 => '/Library/WebServer/Documents/weixin/trunk/application/views/admin/wxsystem/add.html',
      1 => 1491476952,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '168567032758e6221fee21a6-90293659',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58e6221ff202b5_75207181',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58e6221ff202b5_75207181')) {function content_58e6221ff202b5_75207181($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>微信配置添加</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="/Admin_WxSystem/add" method="post" class="form-horizontal">
									<div class="control-group">
										<label class="control-label">公众号名称：</label>
										<div class="controls">
											<input type="text" name="wxs_name" placeholder="请输入公众号名称，最少2位字符" minlength="2" maxlength="18" class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="wxs_app_id" placeholder="请输入AppID，最少2位字符" minlength="2" maxlength="180" class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="wxs_app_secret" placeholder="请输入AppSecret，最少2位字符" minlength="2" maxlength="180" class="span6 m-wrap" />
